...
export function buildRuntimeAssistantMetadataInput(
  ...
  return {
    ...
    scenario_memory_pack_governance_unification_digest_id:
      input.memory.scenario_pack?.governance_unification_digest_id ?? null,
    scenario_memory_pack_strategy_unification_summary:
      input.memory.scenario_pack?.strategy_unification_summary ?? null,
    scenario_memory_pack_orchestration_unification_mode:
      input.memory.scenario_pack?.orchestration_unification_mode ?? null,
    scenario_memory_pack_governance_consolidation_digest_id:
      input.memory.scenario_pack?.governance_consolidation_digest_id ?? null,
    ...
    scenario_memory_pack_governance_plane_digest_id:
      input.memory.scenario_pack?.governance_plane_digest_id ?? null,
    scenario_memory_pack_strategy_governance_plane_summary:
      input.memory.scenario_pack?.strategy_governance_plane_summary ?? null,
    ...
    scenario_memory_pack_governance_fabric_plane_digest_id:
      input.memory.scenario_pack?.governance_fabric_plane_digest_id ?? null,
    scenario_memory_pack_strategy_governance_fabric_plane_summary:
      input.memory.scenario_pack?.strategy_governance_fabric_plane_summary ??
      null,
    scenario_memory_pack_orchestration_governance_fabric_plane_mode:
      input.memory.scenario_pack?.orchestration_governance_fabric_plane_mode ??
      null,
    scenario_memory_pack_governance_fabric_plane_reuse_mode:
      input.memory.scenario_pack?.governance_fabric_plane_reuse_mode ?? null,
    ...
    active_memory_namespace_unified_runtime_reuse_mode:
      namespaceBoundary?.unified_runtime_reuse_mode ?? null,
    active_memory_namespace_governance_consolidation_digest_id:
      namespaceBoundary?.governance_consolidation_digest_id ?? null,
    ...
    active_memory_namespace_unified_consolidation_coordination_summary:
      namespaceBoundary?.unified_consolidation_coordination_summary ?? null,
    active_memory_namespace_unified_consolidation_consistency_mode:
      namespaceBoundary?.unified_consolidation_consistency_mode ?? null,
    active_memory_namespace_governance_plane_runtime_digest_id:
      namespaceBoundary?.governance_plane_runtime_digest_id ?? null,
    active_memory_namespace_governance_plane_runtime_summary:
      namespaceBoundary?.governance_plane_runtime_summary ?? null,
    active_memory_namespace_governance_plane_alignment_mode:
      namespaceBoundary?.governance_plane_alignment_mode ?? null,
    active_memory_namespace_governance_plane_reuse_mode:
      namespaceBoundary?.governance_plane_reuse_mode ?? null,
    active_memory_namespace_governance_fabric_runtime_digest_id:
      namespaceBoundary?.governance_fabric_runtime_digest_id ?? null,
    active_memory_namespace_governance_fabric_runtime_summary:
      namespaceBoundary?.governance_fabric_runtime_summary ?? null,
    ...
    compacted_thread_lifecycle_unification_digest:
      input.compaction.summary?.lifecycle_unification_digest ?? null,
    ...
    compacted_thread_lifecycle_coordination_digest:
      input.compaction.summary?.lifecycle_coordination_digest ?? null,
    compacted_thread_keep_drop_consolidation_coordination_summary:
      input.compaction.summary?.keep_drop_consolidation_coordination_summary ??
      null,
    compacted_thread_lifecycle_coordination_alignment_mode:
      input.compaction.summary?.lifecycle_coordination_alignment_mode ?? null,
    compacted_thread_keep_drop_runtime_coordination_summary:
      input.compaction.summary?.keep_drop_runtime_coordination_summary ?? null,
    compacted_thread_lifecycle_coordination_reuse_mode:
      input.compaction.summary?.lifecycle_coordination_reuse_mode ?? null,
    compacted_thread_lifecycle_governance_plane_digest:
      input.compaction.summary?.lifecycle_governance_plane_digest ?? null,
    compacted_thread_keep_drop_governance_plane_summary:
      input.compaction.summary?.keep_drop_governance_plane_summary ?? null,
    compacted_thread_lifecycle_governance_plane_alignment_mode:
      input.compaction.summary?.lifecycle_governance_plane_alignment_mode ??
      null,
    ...
    compacted_thread_lifecycle_governance_fabric_plane_digest:
      input.compaction.summary?.lifecycle_governance_fabric_plane_digest ??
      null,
    compacted_thread_keep_drop_governance_fabric_plane_summary:
      input.compaction.summary?.keep_drop_governance_fabric_plane_summary ??
      null,
    compacted_thread_lifecycle_governance_fabric_plane_alignment_mode:
      input.compaction.summary
        ?.lifecycle_governance_fabric_plane_alignment_mode ?? null,
    compacted_thread_lifecycle_governance_fabric_plane_reuse_mode:
      input.compaction.summary?.lifecycle_governance_fabric_plane_reuse_mode ??
      null,
