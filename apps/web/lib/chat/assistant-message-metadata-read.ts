...
export function getAssistantMemoryScenarioPackGovernanceConsolidationDigestId(
  metadata: Record<string, unknown> | null | undefined
) {
  const packMetadata = getAssistantMemoryPackMetadata(metadata);
...
export function getAssistantMemoryScenarioPackStrategyConsolidationSummary(
  metadata: Record<string, unknown> | null | undefined
) {
  const packMetadata = getAssistantMemoryPackMetadata(metadata);
...
export function getAssistantMemoryScenarioPackOrchestrationConsolidationMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const packMetadata = getAssistantMemoryPackMetadata(metadata);
...
export function getAssistantThreadKeepDropRuntimeCoordinationSummary(
  metadata: Record<string, unknown> | null | undefined
) {
  const compactionMetadata = getAssistantThreadCompactionMetadata(metadata);
...
export function getAssistantThreadLifecycleCoordinationReuseMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const compactionMetadata = getAssistantThreadCompactionMetadata(metadata);
...
export function getAssistantThreadLifecycleGovernancePlaneDigest(
  metadata: Record<string, unknown> | null | undefined
) {
  const compactionMetadata = getAssistantThreadCompactionMetadata(metadata);
...
export function getAssistantThreadKeepDropGovernancePlaneSummary(
  metadata: Record<string, unknown> | null | undefined
) {
  const compactionMetadata = getAssistantThreadCompactionMetadata(metadata);
...
export function getAssistantThreadLifecycleGovernancePlaneAlignmentMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const compactionMetadata = getAssistantThreadCompactionMetadata(metadata);
...
export function getAssistantThreadLifecycleGovernancePlaneReuseMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const compactionMetadata = getAssistantThreadCompactionMetadata(metadata);
...
export function getAssistantKnowledgeGovernancePlaneDigest(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);

  return (
    getAssistantMetadataString(knowledgeMetadata, "governance_plane_digest") ??
    getAssistantMetadataString(metadata, "knowledge_governance_plane_digest")
  );
}

export function getAssistantKnowledgeSourceBudgetGovernancePlaneSummary(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);
...
export function getAssistantKnowledgeGovernancePlaneMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);

  return (
    getAssistantMetadataString(knowledgeMetadata, "governance_plane_mode") ??
    getAssistantMetadataString(metadata, "knowledge_governance_plane_mode")
  );
}

export function getAssistantKnowledgeGovernancePlaneReuseMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);
...
export function getAssistantKnowledgeGovernanceFabricPlaneDigest(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);
...
export function getAssistantKnowledgeSourceBudgetGovernanceFabricPlaneSummary(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);
...
export function getAssistantKnowledgeGovernanceFabricPlaneMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);
...
export function getAssistantKnowledgeGovernanceFabricPlaneReuseMode(
  metadata: Record<string, unknown> | null | undefined
) {
  const knowledgeMetadata = getAssistantKnowledgeMetadata(metadata);
