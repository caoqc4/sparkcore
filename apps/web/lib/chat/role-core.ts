...
export function buildRoleCoreMemoryCloseNoteArchive(args: {
  ...
  return {
    ...
    source_output_version: closeNoteOutput.output_version,
    readiness_judgment: "archive_close_ready",
    ...
    archive_summary: `namespace_archive_started; retention_archive_started; knowledge_archive_started; scenario_archive_started; source_record = ${closeNoteRecord.record_version}; readiness = archive_close_ready.`,
    blocking_items: [...blockingItems],
    non_blocking_items: [...nonBlockingItems],
    tail_candidate_items: [...tailCandidateItems],
    acceptance_gap_buckets: { ...acceptanceGapBuckets },
    ...
    scenario: {
      phase_snapshot_id: closeNoteRecord.scenario.phase_snapshot_id,
      phase_snapshot_summary: closeNoteRecord.scenario.phase_snapshot_summary,
...
export function buildRoleCoreMemoryCloseNotePersistencePayload(args: {
  ...
  return {
    ...
    persistence_summary: `namespace_persistence_started; retention_persistence_started; knowledge_persistence_started; scenario_persistence_started; source_archive = ${closeNoteArchive.archive_version}; readiness = entered_close_readiness_not_close_ready.`,
    blocking_items: [...blockingItems],
    non_blocking_items: [...nonBlockingItems],
    tail_candidate_items: [...tailCandidateItems],
    acceptance_gap_buckets: { ...acceptanceGapBuckets },
    ...
    scenario: {
      phase_snapshot_id: closeNoteArchive.scenario.phase_snapshot_id,
      phase_snapshot_summary: closeNoteArchive.scenario.phase_snapshot_summary,
