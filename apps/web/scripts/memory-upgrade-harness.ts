...
function main() {
  ...
  const p22CloseNotePersistencePayload =
    buildRoleCoreMemoryCloseNotePersistencePayload({
      roleCorePacket: roleCorePacketForHarness,
      closeNoteArchive: p21CloseNoteArchive,
      closeNoteRecord: p20CloseNoteRecord
    });
  const p23CloseNotePersistenceEnvelope =
    buildRoleCoreMemoryCloseNotePersistenceEnvelope({
      roleCorePacket: roleCorePacketForHarness,
      closeNotePersistencePayload: p22CloseNotePersistencePayload,
      closeNoteArchive: p21CloseNoteArchive
    });
  const p24CloseNotePersistenceManifest =
    buildRoleCoreMemoryCloseNotePersistenceManifest({
      roleCorePacket: roleCorePacketForHarness,
      closeNotePersistenceEnvelope: p23CloseNotePersistenceEnvelope,
      closeNotePersistencePayload: p22CloseNotePersistencePayload
    });
  expect(
  ...
  const assistantMetadata = buildAssistantMessageMetadata(
    buildRuntimeAssistantMetadataInput({
      ...
      runtime: {
        ...
        role_core_close_note_persistence_envelope: p23CloseNotePersistenceEnvelope,
        role_core_close_note_persistence_manifest: p24CloseNotePersistenceManifest,
        role_core_close_note_persistence_payload: p22CloseNotePersistencePayload,
  ...
  const assistantCloseNotePersistencePayload = (assistantMetadata as {
    role_core_close_note_persistence_payload?: typeof p22CloseNotePersistencePayload;
  }).role_core_close_note_persistence_payload;
  const assistantCloseNotePersistenceEnvelope = (assistantMetadata as {
    role_core_close_note_persistence_envelope?: typeof p23CloseNotePersistenceEnvelope;
  }).role_core_close_note_persistence_envelope;
  const assistantCloseNotePersistenceManifest = (assistantMetadata as {
    role_core_close_note_persistence_manifest?: typeof p24CloseNotePersistenceManifest;
  ...
  const assistantDiagnosticCloseNotePersistencePayload = (assistantMetadata as {
    developer_diagnostics?: {
      role_core_close_note_persistence_payload?: typeof p22CloseNotePersistencePayload;
    };
  }).developer_diagnostics?.role_core_close_note_persistence_payload;
  const assistantDiagnosticCloseNotePersistenceEnvelope = (assistantMetadata as {
    developer_diagnostics?: {
      role_core_close_note_persistence_envelope?: typeof p23CloseNotePersistenceEnvelope;
    };
  }).developer_diagnostics?.role_core_close_note_persistence_envelope;
  const assistantDiagnosticCloseNotePersistenceManifest = (assistantMetadata as {
    developer_diagnostics?: {
      role_core_close_note_persistence_manifest?: typeof p24CloseNotePersistenceManifest;
    };
  }).developer_diagnostics?.role_core_close_note_persistence_manifest;
  ...
  const runtimeDebugCloseNotePersistencePayload = (runtimeDebugMetadata.memory as {
    close_note_persistence_payload?: typeof p22CloseNotePersistencePayload;
  }).close_note_persistence_payload;
  const runtimeDebugCloseNotePersistenceEnvelope = (runtimeDebugMetadata.memory as {
    close_note_persistence_envelope?: typeof p23CloseNotePersistenceEnvelope;
  }).close_note_persistence_envelope;
  const runtimeDebugCloseNotePersistenceManifest = (runtimeDebugMetadata.memory as {
    close_note_persistence_manifest?: typeof p24CloseNotePersistenceManifest;
  ...
  const systemPrompt = buildAgentSystemPrompt(
    ...
    p20CloseNoteRecord,
    p21CloseNoteArchive,
    p22CloseNotePersistencePayload,
    p23CloseNotePersistenceEnvelope,
    p24CloseNotePersistenceManifest
  );
  ...
  const p22CloseNotePersistencePayloadPrompt =
    buildRoleCoreMemoryCloseNotePersistencePayloadPrompt(
      p22CloseNotePersistencePayload,
      "en"
    );
  const p23CloseNotePersistenceEnvelopePrompt =
    buildRoleCoreMemoryCloseNotePersistenceEnvelopePrompt(
      p23CloseNotePersistenceEnvelope,
      "en"
    );
  const p24CloseNotePersistenceManifestPrompt =
    buildRoleCoreMemoryCloseNotePersistenceManifestPrompt(
      p24CloseNotePersistenceManifest,
      "en"
    );
  ...
  const p22CloseNotePersistencePayloadChecks = {
    namespace_close_note_persistence_payload_contract_v1_ok:
      p22CloseNotePersistencePayload?.payload_version === "v1" &&
      p22CloseNotePersistencePayload.source_archive_version === "v1" &&
      p22CloseNotePersistencePayload.source_record_version === "v1" &&
      p22CloseNotePersistencePayload.headline.includes(
        "Helper close-note persistence payload"
      ) &&
      p22CloseNotePersistencePayload.namespace.phase_snapshot_id ===
        p21CloseNoteArchive?.namespace.phase_snapshot_id &&
      p22CloseNotePersistencePayload.namespace.persistence_summary.includes(
        p21CloseNoteArchive?.headline ?? ""
      ),
    namespace_close_note_persistence_payload_metadata_consistency_v1_ok:
      assistantCloseNotePersistencePayload?.headline ===
        p22CloseNotePersistencePayload?.headline &&
      assistantDiagnosticCloseNotePersistencePayload?.namespace
        .persistence_summary ===
        p22CloseNotePersistencePayload?.namespace.persistence_summary &&
      runtimeDebugCloseNotePersistencePayload?.persistence_summary ===
    ...
    namespace_close_note_persistence_payload_prompt_surface_v1_ok:
      p22CloseNotePersistencePayloadPrompt.includes(
        "Role core close-note persistence payload"
      ) &&
      p22CloseNotePersistencePayloadPrompt.includes(
        p22CloseNotePersistencePayload?.headline ?? ""
      ) &&
    ...
    knowledge_close_note_persistence_payload_contract_v1_ok:
      ...
      p22CloseNotePersistencePayload?.progress_range === "30% - 35%" &&
      p22CloseNotePersistencePayload?.knowledge.phase_snapshot_id ===
        p21CloseNoteArchive?.knowledge.phase_snapshot_id &&
      p22CloseNotePersistencePayload?.knowledge.governance_classes.join(",") ===
        (p21CloseNoteArchive?.knowledge.governance_classes ?? []).join(",") &&
      p22CloseNotePersistencePayload?.knowledge.persistence_summary.includes(
        (p21CloseNoteArchive?.knowledge.scope_layers ?? []).join(", ")
      ),
    knowledge_close_note_persistence_payload_metadata_consistency_v1_ok:
      assistantCloseNotePersistencePayload?.knowledge.persistence_summary ===
        p22CloseNotePersistencePayload?.knowledge.persistence_summary &&
      assistantDiagnosticCloseNotePersistencePayload?.knowledge
        .governance_classes.join(",") ===
        p22CloseNotePersistencePayload?.knowledge.governance_classes.join(",") &&
      runtimeDebugCloseNotePersistencePayload?.readiness_judgment ===
        p22CloseNotePersistencePayload?.readiness_judgment,
  ...
  const p22GateSnapshot = {
    ...
    positive_contracts: {
      ...
      all_green: p22PositiveContracts.all_green
    },
    metadata_consistency: {
      checks_passed: p22MetadataConsistency.checks_passed,
      checks_total: p22MetadataConsistency.checks_total,
      all_green: p22MetadataConsistency.all_green
    },
    prompt_surface: {
    ...
    overall: {
      ...
      checks_total: p22RegressionGate.checks_total,
      failed_checks: p22RegressionGate.failed_checks,
      all_green: p22RegressionGate.all_green,
      close_candidate: p22RegressionGate.close_candidate
    }
  } as const;
  const p23CloseNotePersistenceEnvelopeChecks = {
    namespace_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelope?.envelope_version === "v1" &&
      p23CloseNotePersistenceEnvelope.source_payload_version === "v1" &&
      p23CloseNotePersistenceEnvelope.source_archive_version === "v1" &&
      p23CloseNotePersistenceEnvelope.headline.includes(
        "Helper close-note persistence envelope"
      ) &&
      p23CloseNotePersistenceEnvelope.namespace.phase_snapshot_id ===
        p22CloseNotePersistencePayload?.namespace.phase_snapshot_id &&
      p23CloseNotePersistenceEnvelope.namespace.persistence_key ===
        `close_note.namespace.${p22CloseNotePersistencePayload?.namespace.phase_snapshot_id ?? ""}` &&
      p23CloseNotePersistenceEnvelope.namespace.envelope_summary.includes(
        "persistence_scope = agent_session"
      ),
    namespace_close_note_persistence_envelope_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceEnvelope?.headline ===
        p23CloseNotePersistenceEnvelope?.headline &&
      assistantDiagnosticCloseNotePersistenceEnvelope?.namespace
        .envelope_summary ===
        p23CloseNotePersistenceEnvelope?.namespace.envelope_summary &&
      runtimeDebugCloseNotePersistenceEnvelope?.envelope_summary ===
        p23CloseNotePersistenceEnvelope?.envelope_summary,
    namespace_close_note_persistence_envelope_prompt_surface_v1_ok:
      p23CloseNotePersistenceEnvelopePrompt.includes(
        "Role core close-note persistence envelope"
      ) &&
      p23CloseNotePersistenceEnvelopePrompt.includes(
        p23CloseNotePersistenceEnvelope?.headline ?? ""
      ) &&
      ...
      systemPrompt.includes("Role core close-note persistence envelope") &&
      systemPrompt.includes(p23CloseNotePersistenceEnvelope?.headline ?? ""),
    retention_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelope?.retention.phase_snapshot_id ===
        p22CloseNotePersistencePayload?.retention.phase_snapshot_id &&
      p23CloseNotePersistenceEnvelope?.retention.decision_group ===
        p22CloseNotePersistencePayload?.retention.decision_group &&
      p23CloseNotePersistenceEnvelope?.retention.persistence_key ===
        `close_note.retention.${p22CloseNotePersistencePayload?.retention.phase_snapshot_id ?? "none"}` &&
      p23CloseNotePersistenceEnvelope?.retention.envelope_summary.includes(
        p22CloseNotePersistencePayload?.retention.retained_fields.join(", ") ?? ""
      ),
    retention_close_note_persistence_envelope_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceEnvelope?.retention.envelope_summary ===
        p23CloseNotePersistenceEnvelope?.retention.envelope_summary &&
      assistantDiagnosticCloseNotePersistenceEnvelope?.retention
        .decision_group ===
        p23CloseNotePersistenceEnvelope?.retention.decision_group &&
      runtimeDebugCloseNotePersistenceEnvelope?.retention.persistence_scope ===
        p23CloseNotePersistenceEnvelope?.retention.persistence_scope,
    retention_close_note_persistence_envelope_prompt_surface_v1_ok:
      ...
      p23CloseNotePersistenceEnvelopePrompt.includes(
        "Retention persistence envelope section"
      ),
    knowledge_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelope?.readiness_judgment ===
        "knowledge_persistence_envelope_started_not_close_ready" &&
      p23CloseNotePersistenceEnvelope?.progress_range === "30% - 35%" &&
      p23CloseNotePersistenceEnvelope?.knowledge.phase_snapshot_id ===
        p22CloseNotePersistencePayload?.knowledge.phase_snapshot_id &&
      p23CloseNotePersistenceEnvelope?.knowledge.governance_classes.join(",") ===
        p22CloseNotePersistencePayload?.knowledge.governance_classes.join(",") &&
      p23CloseNotePersistenceEnvelope?.knowledge.persistence_key ===
        `close_note.knowledge.${p22CloseNotePersistencePayload?.knowledge.phase_snapshot_id ?? ""}`,
    knowledge_close_note_persistence_envelope_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceEnvelope?.knowledge.envelope_summary ===
        p23CloseNotePersistenceEnvelope?.knowledge.envelope_summary &&
      assistantDiagnosticCloseNotePersistenceEnvelope?.knowledge
        .governance_classes.join(",") ===
        p23CloseNotePersistenceEnvelope?.knowledge.governance_classes.join(",") &&
    ...
    knowledge_close_note_persistence_envelope_prompt_surface_v1_ok:
      ...
      p23CloseNotePersistenceEnvelopePrompt.includes(
        "Knowledge persistence envelope section"
      ),
    scenario_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelope?.readiness_judgment ===
        "scenario_persistence_envelope_started_not_close_ready" &&
      p23CloseNotePersistenceEnvelope?.progress_range === "40% - 45%" &&
      p23CloseNotePersistenceEnvelope?.scenario.phase_snapshot_id ===
        p22CloseNotePersistencePayload?.scenario.phase_snapshot_id &&
      p23CloseNotePersistenceEnvelope?.scenario.strategy_bundle_id ===
        p22CloseNotePersistencePayload?.scenario.strategy_bundle_id &&
      p23CloseNotePersistenceEnvelope?.scenario.persistence_key ===
        `close_note.scenario.${p22CloseNotePersistencePayload?.scenario.phase_snapshot_id ?? ""}`,
    scenario_close_note_persistence_envelope_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceEnvelope?.scenario.envelope_summary ===
        p23CloseNotePersistenceEnvelope?.scenario.envelope_summary &&
      assistantDiagnosticCloseNotePersistenceEnvelope?.scenario
        .strategy_bundle_id ===
        p23CloseNotePersistenceEnvelope?.scenario.strategy_bundle_id &&
      runtimeDebugCloseNotePersistenceEnvelope?.scenario.orchestration_mode ===
        p23CloseNotePersistenceEnvelope?.scenario.orchestration_mode,
    scenario_close_note_persistence_envelope_prompt_surface_v1_ok:
      ...
      p23CloseNotePersistenceEnvelopePrompt.includes(
        "Scenario persistence envelope section"
      )
  } as const;
  const p23PositiveContracts = summarizeGate({
    namespace_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.namespace_close_note_persistence_envelope_contract_v1_ok,
    retention_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.retention_close_note_persistence_envelope_contract_v1_ok,
    knowledge_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.knowledge_close_note_persistence_envelope_contract_v1_ok,
    scenario_close_note_persistence_envelope_contract_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.scenario_close_note_persistence_envelope_contract_v1_ok
  });
  const p23MetadataConsistency = summarizeGate({
    namespace_close_note_persistence_envelope_metadata_consistency_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.namespace_close_note_persistence_envelope_metadata_consistency_v1_ok,
    retention_close_note_persistence_envelope_metadata_consistency_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.retention_close_note_persistence_envelope_metadata_consistency_v1_ok,
    knowledge_close_note_persistence_envelope_metadata_consistency_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.knowledge_close_note_persistence_envelope_metadata_consistency_v1_ok,
    scenario_close_note_persistence_envelope_metadata_consistency_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.scenario_close_note_persistence_envelope_metadata_consistency_v1_ok
  });
  const p23PromptSurface = summarizeGate({
    namespace_close_note_persistence_envelope_prompt_surface_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.namespace_close_note_persistence_envelope_prompt_surface_v1_ok,
    retention_close_note_persistence_envelope_prompt_surface_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.retention_close_note_persistence_envelope_prompt_surface_v1_ok,
    knowledge_close_note_persistence_envelope_prompt_surface_v1_ok:
      p23CloseNotePersistenceEnvelopeChecks.knowledge_close_note_persistence_envelope_prompt_surface_v1_ok,
    scenario_close_note_persistence_envelope_prompt_surface_v1_ok:
  ...
  const p23GateSnapshot = {
    ...
    positive_contracts: {
      ...
      all_green: p23PositiveContracts.all_green
    },
    metadata_consistency: {
      checks_passed: p23MetadataConsistency.checks_passed,
      checks_total: p23MetadataConsistency.checks_total,
      all_green: p23MetadataConsistency.all_green
    },
    prompt_surface: {
    ...
    overall: {
      ...
      checks_total: p23RegressionGate.checks_total,
      failed_checks: p23RegressionGate.failed_checks,
      all_green: p23RegressionGate.all_green,
      close_candidate: p23RegressionGate.close_candidate
    }
  } as const;
  const p24CloseNotePersistenceManifestChecks = {
    namespace_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifest?.manifest_version === "v1" &&
      p24CloseNotePersistenceManifest?.source_envelope_version === "v1" &&
      p24CloseNotePersistenceManifest?.source_payload_version === "v1" &&
      p24CloseNotePersistenceManifest?.headline.includes(
        "Helper close-note persistence manifest"
      ) &&
      p24CloseNotePersistenceManifest?.namespace.phase_snapshot_id ===
        p23CloseNotePersistenceEnvelope?.namespace.phase_snapshot_id &&
      p24CloseNotePersistenceManifest?.namespace.persistence_key ===
        p23CloseNotePersistenceEnvelope?.namespace.persistence_key &&
      p24CloseNotePersistenceManifest?.namespace.storage_target ===
        "memory_items" &&
      p24CloseNotePersistenceManifest?.namespace.write_mode ===
        "upsert_close_note_manifest",
    namespace_close_note_persistence_manifest_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceManifest?.headline ===
        p24CloseNotePersistenceManifest?.headline &&
      assistantDiagnosticCloseNotePersistenceManifest?.namespace
        .manifest_summary ===
        p24CloseNotePersistenceManifest?.namespace.manifest_summary &&
      runtimeDebugCloseNotePersistenceManifest?.manifest_summary ===
        p24CloseNotePersistenceManifest?.manifest_summary,
    namespace_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestPrompt.includes(
        "Role core close-note persistence manifest"
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.headline ?? ""
      ) &&
      ...
      systemPrompt.includes("Role core close-note persistence manifest") &&
      systemPrompt.includes(p24CloseNotePersistenceManifest?.headline ?? ""),
    retention_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifest?.readiness_judgment ===
        "scenario_persistence_manifest_started_not_close_ready" &&
      p24CloseNotePersistenceManifest?.progress_range === "30% - 35%" &&
      p24CloseNotePersistenceManifest?.retention.phase_snapshot_id ===
        p23CloseNotePersistenceEnvelope?.retention.phase_snapshot_id &&
      p24CloseNotePersistenceManifest?.retention.decision_group ===
        p23CloseNotePersistenceEnvelope?.retention.decision_group &&
      p24CloseNotePersistenceManifest?.retention.persistence_key ===
        p23CloseNotePersistenceEnvelope?.retention.persistence_key &&
      p24CloseNotePersistenceManifest?.retention.write_mode ===
        "upsert_close_note_manifest",
    retention_close_note_persistence_manifest_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceManifest?.retention.manifest_summary ===
        p24CloseNotePersistenceManifest?.retention.manifest_summary &&
      assistantDiagnosticCloseNotePersistenceManifest?.retention
        .decision_group ===
        p24CloseNotePersistenceManifest?.retention.decision_group &&
      runtimeDebugCloseNotePersistenceManifest?.retention.storage_target ===
        p24CloseNotePersistenceManifest?.retention.storage_target,
    retention_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.retention.manifest_summary ?? ""
      ) &&
      systemPrompt.includes(
      ...
      p24CloseNotePersistenceManifestPrompt.includes(
        "Retention persistence manifest section"
      ),
    knowledge_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifest?.readiness_judgment ===
        "scenario_persistence_manifest_started_not_close_ready" &&
      p24CloseNotePersistenceManifest?.progress_range === "30% - 35%" &&
      p24CloseNotePersistenceManifest?.knowledge.phase_snapshot_id ===
        p23CloseNotePersistenceEnvelope?.knowledge.phase_snapshot_id &&
      p24CloseNotePersistenceManifest?.knowledge.governance_classes.join(",") ===
        p23CloseNotePersistenceEnvelope?.knowledge.governance_classes.join(",") &&
      p24CloseNotePersistenceManifest?.knowledge.persistence_key ===
        p23CloseNotePersistenceEnvelope?.knowledge.persistence_key &&
      p24CloseNotePersistenceManifest?.knowledge.write_mode ===
        "upsert_close_note_manifest",
    knowledge_close_note_persistence_manifest_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceManifest?.knowledge.manifest_summary ===
        p24CloseNotePersistenceManifest?.knowledge.manifest_summary &&
      assistantDiagnosticCloseNotePersistenceManifest?.knowledge
        .governance_classes.join(",") ===
        p24CloseNotePersistenceManifest?.knowledge.governance_classes.join(",") &&
      runtimeDebugCloseNotePersistenceManifest?.knowledge.storage_target ===
        p24CloseNotePersistenceManifest?.knowledge.storage_target,
    knowledge_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.knowledge.manifest_summary ?? ""
      ) &&
      systemPrompt.includes(
      ...
      p24CloseNotePersistenceManifestPrompt.includes(
        "Knowledge persistence manifest section"
      ),
    scenario_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifest?.readiness_judgment ===
        "scenario_persistence_manifest_started_not_close_ready" &&
      p24CloseNotePersistenceManifest?.progress_range === "30% - 35%" &&
      p24CloseNotePersistenceManifest?.scenario.phase_snapshot_id ===
        p23CloseNotePersistenceEnvelope?.scenario.phase_snapshot_id &&
      p24CloseNotePersistenceManifest?.scenario.strategy_bundle_id ===
        p23CloseNotePersistenceEnvelope?.scenario.strategy_bundle_id &&
      p24CloseNotePersistenceManifest?.scenario.persistence_key ===
        p23CloseNotePersistenceEnvelope?.scenario.persistence_key &&
      p24CloseNotePersistenceManifest?.scenario.write_mode ===
        "upsert_close_note_manifest",
    scenario_close_note_persistence_manifest_metadata_consistency_v1_ok:
      assistantCloseNotePersistenceManifest?.scenario.manifest_summary ===
        p24CloseNotePersistenceManifest?.scenario.manifest_summary &&
      assistantDiagnosticCloseNotePersistenceManifest?.scenario
        .strategy_bundle_id ===
        p24CloseNotePersistenceManifest?.scenario.strategy_bundle_id &&
      runtimeDebugCloseNotePersistenceManifest?.scenario.write_mode ===
        p24CloseNotePersistenceManifest?.scenario.write_mode,
    scenario_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.scenario.manifest_summary ?? ""
      ) &&
      systemPrompt.includes(
      ...
      p24CloseNotePersistenceManifestPrompt.includes(
        "Scenario persistence manifest section"
      )
  } as const;
  const p24PositiveContracts = summarizeGate({
    namespace_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifestChecks.namespace_close_note_persistence_manifest_contract_v1_ok,
    retention_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifestChecks.retention_close_note_persistence_manifest_contract_v1_ok,
    knowledge_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifestChecks.knowledge_close_note_persistence_manifest_contract_v1_ok,
    scenario_close_note_persistence_manifest_contract_v1_ok:
      p24CloseNotePersistenceManifestChecks.scenario_close_note_persistence_manifest_contract_v1_ok
  });
  const p24MetadataConsistency = summarizeGate({
    namespace_close_note_persistence_manifest_metadata_consistency_v1_ok:
      p24CloseNotePersistenceManifestChecks.namespace_close_note_persistence_manifest_metadata_consistency_v1_ok,
    retention_close_note_persistence_manifest_metadata_consistency_v1_ok:
      p24CloseNotePersistenceManifestChecks.retention_close_note_persistence_manifest_metadata_consistency_v1_ok,
    knowledge_close_note_persistence_manifest_metadata_consistency_v1_ok:
      p24CloseNotePersistenceManifestChecks.knowledge_close_note_persistence_manifest_metadata_consistency_v1_ok,
    scenario_close_note_persistence_manifest_metadata_consistency_v1_ok:
      p24CloseNotePersistenceManifestChecks.scenario_close_note_persistence_manifest_metadata_consistency_v1_ok
  });
  const p24PromptSurface = summarizeGate({
    namespace_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestChecks.namespace_close_note_persistence_manifest_prompt_surface_v1_ok,
    retention_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestChecks.retention_close_note_persistence_manifest_prompt_surface_v1_ok,
    knowledge_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestChecks.knowledge_close_note_persistence_manifest_prompt_surface_v1_ok,
    scenario_close_note_persistence_manifest_prompt_surface_v1_ok:
      p24CloseNotePersistenceManifestChecks.scenario_close_note_persistence_manifest_prompt_surface_v1_ok
  });
  const p24CloseReadinessConsumptionChecks = {
    role_core_memory_close_note_persistence_manifest_close_readiness_prompt_v1_ok:
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.readiness_judgment ?? ""
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.progress_range ?? ""
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.close_note_recommended
          ? "true"
          : "false"
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        `blocking = ${p24CloseNotePersistenceManifest?.acceptance_gap_buckets.blocking ?? 0}`
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        "close_readiness_persistence_manifest_consumption"
      ),
    role_core_memory_close_note_persistence_manifest_gap_bucket_consumption_v1_ok:
      assistantCloseNotePersistenceManifest?.readiness_judgment ===
        p24CloseNotePersistenceManifest?.readiness_judgment &&
      assistantCloseNotePersistenceManifest?.progress_range ===
        p24CloseNotePersistenceManifest?.progress_range &&
      assistantCloseNotePersistenceManifest?.close_note_recommended ===
        p24CloseNotePersistenceManifest?.close_note_recommended &&
      assistantCloseNotePersistenceManifest?.acceptance_gap_buckets
        .non_blocking ===
        p24CloseNotePersistenceManifest?.acceptance_gap_buckets.non_blocking &&
      assistantDiagnosticCloseNotePersistenceManifest?.acceptance_gap_buckets
        .tail_candidate ===
        p24CloseNotePersistenceManifest?.acceptance_gap_buckets
          .tail_candidate &&
      runtimeDebugCloseNotePersistenceManifest?.readiness_judgment ===
        p24CloseNotePersistenceManifest?.readiness_judgment &&
      runtimeDebugCloseNotePersistenceManifest?.progress_range ===
        p24CloseNotePersistenceManifest?.progress_range &&
      runtimeDebugCloseNotePersistenceManifest?.acceptance_gap_buckets
        .blocking ===
        p24CloseNotePersistenceManifest?.acceptance_gap_buckets.blocking &&
      runtimeDebugCloseNotePersistenceManifest?.next_expansion_focus.includes(
        "close_readiness_persistence_manifest_consumption"
      ),
    role_core_memory_close_note_persistence_manifest_gap_structuring_v1_ok:
      (p24CloseNotePersistenceManifest?.blocking_items.length ?? 0) ===
        (p24CloseNotePersistenceManifest?.acceptance_gap_buckets.blocking ??
          -1) &&
      (p24CloseNotePersistenceManifest?.non_blocking_items.length ?? 0) ===
        (p24CloseNotePersistenceManifest?.acceptance_gap_buckets.non_blocking ??
          -1) &&
      (p24CloseNotePersistenceManifest?.tail_candidate_items.length ?? 0) ===
        (p24CloseNotePersistenceManifest?.acceptance_gap_buckets
          .tail_candidate ?? -1) &&
      p24CloseNotePersistenceManifest?.next_expansion_focus.includes(
    ...
    role_core_memory_close_note_persistence_manifest_close_note_input_readiness_v1_ok:
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.non_blocking_items.join(", ") ?? ""
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.tail_candidate_items.join(", ") ?? ""
      ) &&
      p24CloseNotePersistenceManifestPrompt.includes(
        p24CloseNotePersistenceManifest?.next_expansion_focus.join(", ") ?? ""
      ) &&
      systemPrompt.includes(
        p24CloseNotePersistenceManifest?.non_blocking_items.join(", ") ?? ""
      ) &&
      ...
      (assistantCloseNotePersistenceManifest?.non_blocking_items.length ??
        -1) ===
        (p24CloseNotePersistenceManifest?.non_blocking_items.length ?? -2) &&
      (assistantDiagnosticCloseNotePersistenceManifest?.tail_candidate_items
        .length ?? -1) ===
        (p24CloseNotePersistenceManifest?.tail_candidate_items.length ?? -2) &&
      (runtimeDebugCloseNotePersistenceManifest?.next_expansion_focus.length ??
        -1) ===
        (p24CloseNotePersistenceManifest?.next_expansion_focus.length ?? -2)
  } as const;
  const p24CloseReadinessConsumption = summarizeGate(
    p24CloseReadinessConsumptionChecks
  );
  const p24RegressionGate = {
    positive_contracts: p24PositiveContracts,
    metadata_consistency: p24MetadataConsistency,
    prompt_surface: p24PromptSurface,
    close_readiness_consumption: p24CloseReadinessConsumption,
    ...summarizeGate({
      ...p24CloseNotePersistenceManifestChecks,
      ...p24CloseReadinessConsumptionChecks
    })
  } as const;
  const p24GateSnapshot = {
    gate_id: "p24_regression_gate_v2",
    stage: "P24-5",
    focus: "close_note_persistence_manifestization",
    persistence_manifest_readiness:
      p24CloseNotePersistenceManifest?.close_note_recommended === true
        ? "persistence_manifest_close_ready"
        : "persistence_manifest_close_readiness_consumption_started",
    progress_range: p24CloseNotePersistenceManifest?.progress_range ?? "unknown",
    close_note_recommended:
      p24CloseNotePersistenceManifest?.close_note_recommended ?? false,
    blocking_items: p24CloseNotePersistenceManifest?.blocking_items ?? [],
    non_blocking_items:
      p24CloseNotePersistenceManifest?.non_blocking_items ?? [],
    tail_candidate_items:
      p24CloseNotePersistenceManifest?.tail_candidate_items ?? [],
    acceptance_gap_buckets:
      p24CloseNotePersistenceManifest?.acceptance_gap_buckets ?? {
        blocking: 0,
        non_blocking: 0,
    ...
    next_expansion_focus:
      p24CloseNotePersistenceManifest?.next_expansion_focus ?? [],
    positive_contracts: {
      checks_passed: p24PositiveContracts.checks_passed,
      checks_total: p24PositiveContracts.checks_total,
      all_green: p24PositiveContracts.all_green
    },
    metadata_consistency: {
      checks_passed: p24MetadataConsistency.checks_passed,
      checks_total: p24MetadataConsistency.checks_total,
      all_green: p24MetadataConsistency.all_green
    },
    prompt_surface: {
      checks_passed: p24PromptSurface.checks_passed,
      checks_total: p24PromptSurface.checks_total,
      all_green: p24PromptSurface.all_green
    },
    close_readiness_consumption: {
      checks_passed: p24CloseReadinessConsumption.checks_passed,
      checks_total: p24CloseReadinessConsumption.checks_total,
      all_green: p24CloseReadinessConsumption.all_green
    },
    overall: {
      checks_passed: p24RegressionGate.checks_passed,
      checks_total: p24RegressionGate.checks_total,
      failed_checks: p24RegressionGate.failed_checks,
      all_green: p24RegressionGate.all_green,
      close_candidate: p24RegressionGate.close_candidate
    }
  } as const;
  ...
  console.log(
    JSON.stringify(
      ...
      !getAssistantCompactedThreadSummaryText(assistantMetadata)?.includes(
        ...
        p24_close_note_persistence_manifest:
          p24CloseNotePersistenceManifestChecks,
        p24_regression_gate: p24RegressionGate,
        p24_gate_snapshot: p24GateSnapshot,
        p23_close_note_persistence_envelope:
          p23CloseNotePersistenceEnvelopeChecks,
        p23_regression_gate: p23RegressionGate,
        p23_gate_snapshot: p23GateSnapshot,
        p22_close_note_persistence_payload:
          p22CloseNotePersistencePayloadChecks,
        p22_regression_gate: p22RegressionGate,
        p22_gate_snapshot: p22GateSnapshot,
