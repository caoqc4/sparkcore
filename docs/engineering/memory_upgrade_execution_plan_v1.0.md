...
- `P0 ~ P5` 的非阻塞尾项当前已统一收束到 [memory_upgrade_tail_cleanup_backlog_v1.0.md](/Users/caoq/git/sparkcore/docs/engineering/memory_upgrade_tail_cleanup_backlog_v1.0.md)，后续如需处理，请优先按 batch 方式推进，而不要回头阻塞主线
