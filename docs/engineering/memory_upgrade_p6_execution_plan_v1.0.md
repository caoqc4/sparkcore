...
- **继续补 `P6-2 Retention lifecycle policy v4` 的第二刀**
- 在 `retention_policy_id / cross_layer_survival_mode` 已成立之后，优先把 lifecycle policy 再推进到更明确的 keep-drop grouping / survival rationale
